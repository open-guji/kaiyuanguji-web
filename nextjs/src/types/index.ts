...
export interface ResourceEntry {
  ...
  structure?: string[];
  coverage?: { level: number; ranges: string };
  details?: string;
}
...
export interface BaseDetailData {
  ...
  resources?: ResourceEntry[];         // 新统一字段
  text_resources?: ResourceLink[];     // 旧字段（兼容）
  image_resources?: ResourceLink[];    // 旧字段（兼容）
